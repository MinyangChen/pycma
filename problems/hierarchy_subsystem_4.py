...
class HierarchySubsystemProblem4:
    """Hierarchy benchmark with Griewank replacing the easiest Ackley blocks for added difficulty."""

    def __init__(self, name: str = "hierarchy_subsystem_4") -> None:
        self._dim = 100
        ...
        # self._top_rosenbrock = ShiftedRotatedRosenbrockProblem(dim=10)
    ...
    def evaluate_with_details(self, x: np.ndarray):
        ...
        z_vals = []
        detail = {}
        top_opt = self._top_rosenbrock.optimum
        ...
        top_value = self._top_rosenbrock(z)
        detail["Top_ShiftedRotatedRosenbrock"] = top_value
...
if __name__ == "__main__":
    problem = HierarchySubsystemProblem4()
