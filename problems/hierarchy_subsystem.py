...
class HierarchySubsystemProblem:
    """Hierarchy benchmark linking ten shifted/rotated subsystems via a top-level Rosenbrock interaction."""

    def __init__(self, name: str = "hierarchy_subsystem") -> None:
        self._dim = 100
        self._lower_bound = -32.768
        self._upper_bound = 32.768
        self._name = name

        # Subproblem instances (each dim=10) with stored optima/rotations
...
if __name__ == "__main__":
    problem = HierarchySubsystemProblem()

    # Optimal solution: concatenate optima
