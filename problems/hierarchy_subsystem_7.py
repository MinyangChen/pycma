...
class HierarchySubsystemProblem5:
    ...
    def __init__(self, name: str = "hierarchy_subsystem_5") -> None:
        ...
        self._top_ellipsoid = ShiftedRotatedRotatedEllipsoidProblem(dim=10)
...
if __name__ == "__main__":
    problem = HierarchySubsystemProblem5()
