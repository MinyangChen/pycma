...
class HierarchySubsystemProblem3:
    """Hierarchy benchmark with Griewank blocks replacing the hardest ellipsoid components."""

    def __init__(self, name: str = "hierarchy_subsystem_3") -> None:
        self._dim = 100
        ...
        self._extra_griewank_block = ShiftedRotatedGriewankProblem(dim=10)
    ...
    def evaluate_with_details(self, x: np.ndarray):
        ...
        z_vals.append(block_value(self._scale_block(chunks[2], self._griewank_block), self._griewank_block, "ShiftedRotatedGriewank_1", 2))
        z_vals.append(block_value(self._scale_block(chunks[3], self._griewank_block), self._griewank_block, "ShiftedRotatedGriewank_2", 3))
        ...
        z_vals.append(block_value(self._scale_block(chunks[8], self._extra_griewank_block), self._extra_griewank_block, "ShiftedRotatedGriewank_3", 8))
        z_vals.append(block_value(self._scale_block(chunks[9], self._extra_griewank_block), self._extra_griewank_block, "ShiftedRotatedGriewank_4", 9))
...
if __name__ == "__main__":
    problem = HierarchySubsystemProblem3()
    ...
    opt_solution = np.concatenate([
        ...
        problem._scale_back(problem._schwefel_block.optimum, problem._schwefel_block),
        problem._scale_back(problem._extra_griewank_block.optimum, problem._extra_griewank_block),
        problem._scale_back(problem._extra_griewank_block.optimum, problem._extra_griewank_block),
    ])
