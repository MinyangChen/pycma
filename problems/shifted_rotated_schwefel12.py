...
class ShiftedRotatedSchwefel12Problem:
    """Schwefel 1.2 function with fixed-dimensional shift and rotation."""
    ...
    def __init__(
        ...
        name: str = "shifted_rotated_schwefel12",
        ...
        if dim != 10:
            raise ValueError("ShiftedRotatedSchwefel12Problem is defined for dim=10.")
        ...
        if rotation_path is None:
            rotation_path = os.path.join(base_dir, "shifted_rotated_schwefel12_rotation.txt")
    ...
    def evaluate(self, x: np.ndarray) -> np.ndarray:
        ...
        cumulative = np.cumsum(rotated, axis=1)
